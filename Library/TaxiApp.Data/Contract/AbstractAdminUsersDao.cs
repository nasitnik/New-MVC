...
{
    public abstract class AbstractAdminUsersDao : AbstractBaseDao
    {
        ...
        public abstract SuccessResult<AbstractAdminUsers> AdminUsers_Login(string Email, string PasswordHash);
